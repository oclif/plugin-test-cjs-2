...
running command...
$ cjs2 (--version)
@oclif/plugin-test-cjs-2/0.7.17 linux-x64 node-v18.20.4
$ cjs2 --help [COMMAND]
USAGE
  $ cjs2 COMMAND
...
...
_See code: [src/commands/cjs2.ts](https://github.com/oclif/plugin-test-cjs-2/blob/0.7.17/src/commands/cjs2.ts)_
